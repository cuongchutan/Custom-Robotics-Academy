...
class MyAlgorithm(threading.Thread):
    ...
    def algorithm(self):
        ...
        data = self.getReadings('accelerometer' , 'orientation' , 'color_img' , 'depth_img')
        # to get readings data from particular sensors
        ...
        # set predicted path at once /or reset the previously set predicted poses at once
        # ---- path should be Nx2 numpy array or python list [x,y].
